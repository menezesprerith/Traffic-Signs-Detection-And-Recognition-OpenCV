...
def main():
    ...
    # pedestrian_haar_cascade = cv.CascadeClassifier('pedestrian_haar_classifier.xml')
    # bus_front_haar_cascade = cv.CascadeClassifier('bus_front_haar_classifier.xml')
    # cars_haar_cascade = cv.CascadeClassifier('cars_haar_classifier.xml')
    # two_wheeler_haar_cascade = cv.CascadeClassifier('two_wheeler_haar_classifier.xml')
